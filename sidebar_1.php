            ...
            <div id="tree-wrap">
                <div class="side-bar">
                    <ul class="topnav menu-left-nest">
                        ...
                        <li class="hide1">
                            <a class="tooltip-tip ajax-load" href="#" title="company">
                                <i class="icon-document-edit"></i>
                                <span>Company</span>
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/vms/php/com_insert_0.php" title="Add"><i class="entypo-doc-text"></i><span>Add</span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/vms/php/com_display_0.php" title="View"><i class="entypo-doc-text"></i><span>View</span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/vms/php/com_delete1_0.php" title="Delete"><i class="entypo-doc-text"></i><span>Delete</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="hide1">
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/vms/php/admin_insert_0.php" title="Add"><i class="entypo-doc-text"></i><span>Add</span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/vms/php/admin_display_0.php" title="View"><i class="entypo-doc-text"></i><span>View</span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/vms/php/admin_delete1_0.php" title="Delete"><i class="entypo-doc-text"></i><span>Delete</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="hide1">
