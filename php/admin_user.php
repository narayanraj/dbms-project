...
<html class="no-js">
<head>
	<title>Add Admin User Record</title>
...
<form action="admin_user_insert_0.php" method="post" enctype="multipart/form-data">
	<div class="admin_transparent">
		<div class="admin_main">
			<span style="color: white; font-size: 64px;font-family: sans-serif;">Admin Account Creation</span>
		...
		<label style="font-size: 16px; color: white;">Salary </label>	
				<input type="text" name="sal" placeholder="Enter your salary" required style="width: 70%; height:1px; border-radius: 10px;border:none; margin-left: 22px; padding: 16px;margin-top: 10px; background-color: antiquewhite;"><br><br>
			<label style="font-size: 16px; color: white;">Status </label>	
				<input type="text" name="status" placeholder="select active default" required style="width: 70%; height:1px; border-radius: 10px;border:none; margin-left: 22px; padding: 16px;margin-top: 10px; background-color: antiquewhite;"><br><br>
		...
		<!--		<div class="box">
				...
				<br><br>
				<div class="sign">
					<input type="submit" value="Add New Admin" style="width: 30%; height:32px; border-radius: 10px;border:none; margin-left: 22px; margin-top: 10px; background-color: antiquewhite; cursor: pointer; color: black;" ><br><br>
				</div>
			</div>
		</div>
	</div>
